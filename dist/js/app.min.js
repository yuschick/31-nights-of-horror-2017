...
var r=n(6)
e.exports={moviesDatabase:null,fetch:function(e){return r.database().ref("/"+e+"/").once("value").then(function(e){return e.val()})},post:function(e,t){var n=void 0
r.database().ref("/tracking/"+(e-1)).once("value").then(function(i){n=i.val(),n.tracking[t]++,r.database().ref("/tracking/"+(e-1)).set(n)})},init:function(){var e={apiKey:"AIzaSyDj19pdN2v4FPRgK89BRHOHUNf4T8eLwKY",authDomain:"horror-calendar-2017.firebaseapp.com",databaseURL:"https://horror-calendar-2017.firebaseio.com",projectId:"horror-calendar-2017",storageBucket:"horror-calendar-2017.appspot.com"}
